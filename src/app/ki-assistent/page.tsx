    ...
    <>
      <PageHero
        overline={
          <div className="inline-flex items-center gap-2 bg-white/10 border border-white/20 rounded-full px-4 py-1.5 mb-6">
            ...
            <span className="text-sm text-blue-100 font-medium">Powered by KI-Sprachmodelle der neuesten Generation</span>
          </div>
        }
        title={
          <>
      ...
      >
        <div className="flex flex-col sm:flex-row gap-4 mt-8">
          <a
            href="#live-demo"
            className="inline-flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-500 text-white font-semibold px-8 py-4 rounded-xl transition-colors text-base"
          >
          ...
          <a
            href="#preise"
            className="inline-flex items-center justify-center gap-2 bg-white/10 hover:bg-white/20 border border-white/20 text-white font-semibold px-8 py-4 rounded-xl transition-colors text-base"
          >
            Preise ansehen
      ...
      {/* Pricing */}
      <section id="preise" className={cn('bg-slate-50 border-y border-slate-200', sectionPadding)}>
        <div className={container}>
          <div className="text-center mb-14">
            <h2 className="text-3xl sm:text-4xl font-bold text-slate-900 mb-4">
              Transparente Preise
      ...
      {/* Live Demo / CTA */}
      <section id="live-demo" className={cn('bg-gradient-to-b from-white to-slate-50', sectionPadding)}>
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <a
            href="#live-demo"
            className="inline-flex items-center gap-2.5 bg-blue-600 hover:bg-blue-700 text-white font-semibold px-10 py-4 rounded-xl text-base transition-colors shadow-lg shadow-blue-200"
          >
            <Phone className="w-5 h-5" />
            Testgespräch starten
          </a>
