  ...
  return (
    <>
      <PageHero
        ...
        title={`Immobilienmakler ${cityData.name}`}
        subtitle={`${brokers.length} geprüfte Makler in ${cityData.name} – mit echten Bewertungen von Eigentümern und Käufern. Finden Sie den Experten für Ihre Immobilie.`}
      />
